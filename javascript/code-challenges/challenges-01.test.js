...
const allUpperCase = (arr) => {
  const newUpper = [];
  arr.forEach((word) => {
    newUpper.push(word.toUpperCase());
  });
  return newUpper;
};
/* ------------------------------------------------------------------------------------------------
...
// thanks to Brandon Gonzalez for taking the time to work through this one with me!
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
Write a function named addValues that takes in an array and a value and pushes the value into the array. This function does not need a return statement.
Then, write a function named addNumbers that takes in four arguments:
	- A number to be added to an array (we want to add a number to an array)
	- An array into which the number should be added (the array where we're adding the number)
	- The number of times the number should be added (# times the number will be added)
...
// plan of action: add 'num" (represents x number) to the 'arr', add the number "times" times. invoke call "arr.push(value)"
// thanks again to Brandon for helping me figure out the best way to solve these code challenges!
...
// plan of action: use forEach to cycle through the list "available items" and if the available = true, add to 'createlist'
